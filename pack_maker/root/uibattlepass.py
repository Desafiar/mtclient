...
class UiBattlePassButton(ui.ScriptWindow):
	...
	def LoadWindow(self):
		...
		self.elements["button_battlepass"].SetUpVisual(RUTA_IMGS + "bp_boton_1.tga")
		self.elements["button_battlepass"].SetOverVisual(RUTA_IMGS + "bp_boton_2.tga")
		self.elements["button_battlepass"].SetDownVisual(RUTA_IMGS + "bp_boton_3.tga")
...
class UiBattlePass(ui.ScriptWindow):
	...
	def LoadElements(self):
		for i in xrange(0,self.pages_view):
			...
			self.elements["select_mision_%d"%i].SetUpVisual(RUTA_IMGS+"boton_mision_1.tga")
			self.elements["select_mision_%d"%i].SetOverVisual(RUTA_IMGS+"boton_mision_2.tga")
			self.elements["select_mision_%d"%i].SetDownVisual(RUTA_IMGS+"boton_mision_3.tga")
			...
			self.elements["corona_plata_img_%d"%i].LoadImage(RUTA_IMGS+"corona_plata_new.tga")
			...
			self.elements["info_mision_%d"%i].LoadImage(RUTA_IMGS+"info_icon.tga")
	...
	def CheckButtonRecompensa(self,index):
		if self.CheckCompleteMision(index) and not self.CheckRewardStatus(index):
			self.recibir_recompensa_button.SetUpVisual(RUTA_IMGS+"reward_1.tga")
			self.recibir_recompensa_button.SetOverVisual(RUTA_IMGS+"reward_2.tga")
			self.recibir_recompensa_button.SetDownVisual(RUTA_IMGS+"reward_3.tga")
		else:
			self.recibir_recompensa_button.SetUpVisual(RUTA_IMGS+"no_reward.tga")
			self.recibir_recompensa_button.SetOverVisual(RUTA_IMGS+"no_reward.tga")
			self.recibir_recompensa_button.SetDownVisual(RUTA_IMGS+"no_reward.tga")
