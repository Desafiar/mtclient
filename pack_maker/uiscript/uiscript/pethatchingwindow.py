	...
	(
		{
			...
			(
				# Pet Hatching Window Title
				{
					...
					"children" :
					(
						{ "name":"TitleName", "type":"text", "x":0, "y":0, "text":uiScriptLocale.PET_SYSTEM_1, "all_align":"center" },
					),
				},
				...
				## Pet Hatching Money
				{
					...
					"children" :
					(
						{"name":"HatchingMoney", "type":"text", "x":0, "y":0, "text": uiScriptLocale.SHOP_CREATE_PRICE+" 100.000 Yang", "r":1.0, "g":1.0, "b":1.0, "a":1.0, "all_align" : "center"},
					),
				},
				...
				{ 
					...
					"children" :
					(
						{"name":"PetNamingTitle", "type":"text", "x":0, "y":0, "text":uiScriptLocale.CREATE_NAME, "all_align" : "center"},
					),
				},
			),				
		},
