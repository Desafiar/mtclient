...
class AffectImage(ui.ExpandedImageBox):
	...
	def UpdateAutoPotionDescription(self):
		...
		elif self.affect == chr.NEW_AFFECT_AUTO_HP_RECOVERY:
	...
	def UpdateDescription(self):
		...
		if self.endTime > 0:
			...
			if app.ENABLE_IMPROVED_AUTOMATIC_HUNTING_SYSTEM and self.GetAffect() == chr.NEW_AFFECT_AUTO_USE:
			...
			if self.GetAffect() == chr.NEW_AFFECT_VOTE4BUFF:
				...
				if interface:
					if interface.tooltipItem:
						...
						interface.tooltipItem.AppendSpace(5)
						interface.tooltipItem.AutoAppendNewTextLineResize(uiToolTip.ItemToolTip.POINT_DICT[voteBuffData[0]](voteBuffData[1]))
						interface.tooltipItem.AppendSpace(5)
						if self.endTime > 0:
							time = self.endTime - app.GetGlobalTimeStamp()
							day = int(int((time / 60) / 60) / 24)
...
class AffectShower(ui.Window):
	...
	AFFECT_DATA_DICT =	{
			...
			# ÀÚµ¿¹°¾à hp, sp
			chr.NEW_AFFECT_AUTO_HP_RECOVERY : (localeInfo.TOOLTIP_AUTO_POTION_REST, "icon/item/elixir_rojo.tga"),
			chr.NEW_AFFECT_AUTO_SP_RECOVERY : (localeInfo.TOOLTIP_AUTO_POTION_REST, "icon/item/elixir_azul.tga"),
			...
			MALL_DESC_IDX_START+player.POINT_CRITICAL_PCT : (localeInfo.TOOLTIP_APPLY_CRITICAL_PCT,"icon/item/79051_1.tga"),
			MALL_DESC_IDX_START+player.POINT_PENETRATE_PCT : (localeInfo.TOOLTIP_APPLY_PENETRATE_PCT, "icon/item/79052_1.tga"),
			MALL_DESC_IDX_START+player.POINT_MAX_HP_PCT : (localeInfo.TOOLTIP_MAX_HP_PCT, "icon/item/79053_1.tga"),
			MALL_DESC_IDX_START+player.POINT_MAX_SP_PCT : (localeInfo.TOOLTIP_MAX_SP_PCT, "icon/item/79054_1.tga"),
	...
	if app.__RENEWAL_CRYSTAL__:
		AFFECT_DATA_DICT[chr.NEW_AFFECT_CRYSTAL] =  (localeInfo.NEW_AFFECT_CRYSTAL, "icon/affectshower/crystal.tga")
	if app.ENABLE_VOTE4BUFF:
		AFFECT_DATA_DICT[chr.NEW_AFFECT_VOTE4BUFF] =  (localeInfo.NEW_AFFECT_VOTE4BUFF, "icon/affectshower/vote4buff.tga")

	if app.ENABLE_SUNGMA_POTION:
		AFFECT_DATA_DICT[chr.NEW_AFFECT_SUNGMA_POTION_STR] =  (localeInfo.NEW_AFFECT_SUNGMA_POTION_STR, "icon/affectshower/STR.tga")
		AFFECT_DATA_DICT[chr.NEW_AFFECT_SUNGMA_POTION_VIT] =  (localeInfo.NEW_AFFECT_SUNGMA_POTION_VIT, "icon/affectshower/VIT.tga")
		AFFECT_DATA_DICT[chr.NEW_AFFECT_SUNGMA_POTION_RES] =  (localeInfo.NEW_AFFECT_SUNGMA_POTION_RES, "icon/affectshower/RES.tga")
		AFFECT_DATA_DICT[chr.NEW_AFFECT_SUNGMA_POTION_INT] =  (localeInfo.NEW_AFFECT_SUNGMA_POTION_INT, "icon/affectshower/INT.tga")
	...
	if app.ENABLE_NEW_AUTOPOTION:
		AFFECT_DATA_DICT[chr.AFFECT_AUTO_ATTACK_SPEED_RECOVERY + 20] = (localeInfo.TOOLTIP_AUTO_ATTACK_SPEED_RECOVERY, "icon/item/verde_arriba.tga")
		AFFECT_DATA_DICT[chr.AFFECT_AUTO_MOV_SPEED_RECOVERY + 20]    = (localeInfo.TOOLTIP_AUTO_MOV_SPEED_RECOVERY, "icon/item/morada.tga")
		AFFECT_DATA_DICT[chr.AFFECT_AUTO_CRITICAL_RECOVERY + 20]     = (localeInfo.TOOLTIP_AUTO_CRITICAL_RECOVERY, "icon/item/79051_1.tga")
		AFFECT_DATA_DICT[chr.AFFECT_AUTO_PENETRATE_RECOVERY + 20]    = (localeInfo.TOOLTIP_AUTO_PENETRATE_RECOVERY, "icon/item/79052_1.tga")
		AFFECT_DATA_DICT[chr.AFFECT_AUTO_VIT_RECOVERY + 20]          = (localeInfo.TOOLTIP_AUTO_VIT_RECOVERY, "icon/item/79053_1.tga")
		AFFECT_DATA_DICT[chr.AFFECT_AUTO_STR_RECOVERY + 20]          = (localeInfo.TOOLTIP_AUTO_STR_RECOVERY, "icon/item/79054_1.tga")
		AFFECT_DATA_DICT[chr.AFFECT_AUTO_INT_RECOVERY + 20]          = (localeInfo.TOOLTIP_AUTO_INT_RECOVERY, "icon/item/79055_1.tga")
		AFFECT_DATA_DICT[chr.AFFECT_AUTO_DEX_RECOVERY + 20]          = (localeInfo.TOOLTIP_AUTO_DEX_RECOVERY, "icon/item/79056_1.tga")

		AFFECT_DATA_DICT[chr.AFFECT_AUTO_RED_POTION_RECOVERY + 20]          = (localeInfo.TOOLTIP_AUTO_RED_POTION_RECOVERY, "icon/item/79057_1.tga")
		AFFECT_DATA_DICT[chr.AFFECT_AUTO_ORANGE_POTION_RECOVERY + 20]          = (localeInfo.TOOLTIP_AUTO_ORANGE_POTION_RECOVERY, "icon/item/79058_1.tga")
		AFFECT_DATA_DICT[chr.AFFECT_AUTO_YELLOW_POTION_RECOVERY + 20]          = (localeInfo.TOOLTIP_AUTO_YELLOW_POTION_RECOVERY, "icon/item/79059_1.tga")
		AFFECT_DATA_DICT[chr.AFFECT_AUTO_GREEN_POTION_RECOVERY + 20]          = (localeInfo.TOOLTIP_AUTO_GREEN_POTION_RECOVERY, "icon/item/79060_1.tga")
		AFFECT_DATA_DICT[chr.AFFECT_AUTO_BLUE_POTION_RECOVERY + 20]          = (localeInfo.TOOLTIP_AUTO_BLUE_POTION_RECOVERY, "icon/item/79061_1.tga")
		AFFECT_DATA_DICT[chr.AFFECT_AUTO_WHITE_POTION_RECOVERY + 20]          = (localeInfo.TOOLTIP_AUTO_WHITE_POTION_RECOVERY, "icon/item/79062_1.tga")
	...
	if app.ENABLE_NEW_AFFECT_POTION:
		AFFECT_DATA_DICT[chr.AFFECT_POTION_1] = (localeInfo.TOOLTIP_AFFECT_POTION_1, "icon/item/79057_1.tga")
		AFFECT_DATA_DICT[chr.AFFECT_POTION_2] = (localeInfo.TOOLTIP_AFFECT_POTION_2, "icon/item/79058_1.tga")
		AFFECT_DATA_DICT[chr.AFFECT_POTION_3] = (localeInfo.TOOLTIP_AFFECT_POTION_3, "icon/item/79059_1.tga")
		AFFECT_DATA_DICT[chr.AFFECT_POTION_4] = (localeInfo.TOOLTIP_AFFECT_POTION_4, "icon/item/79060_1.tga")
		AFFECT_DATA_DICT[chr.AFFECT_POTION_5] = (localeInfo.TOOLTIP_AFFECT_POTION_5, "icon/item/79061_1.tga")
		AFFECT_DATA_DICT[chr.AFFECT_POTION_6] = (localeInfo.TOOLTIP_AFFECT_POTION_6, "icon/item/79062_1.tga")
	...
	if app.__SKILL_TREE__:
		AFFECT_DATA_DICT[chr.NEW_AFFECT_SKILL_TREE] =  (localeInfo.NEW_AFFECT_SKILL_TREE, "icon/affectshower/skill_tree.tga")
	...
	if app.ENABLE_AUTOMATIC_PICK_UP_SYSTEM:
		AFFECT_DATA_DICT[chr.NEW_AFFECT_AUTO_PICK_UP] = (localeInfo.NEW_AFFECT_AUTO_PICK_UP, "d:/ymir work/ui/game/farm/premium_pickup.tga")
	...
	def ClearAffects(self): ## ½ºÅ³ ÀÌÆåÆ®¸¸ ¾ø¾Û´Ý´Ù.
	...
	def BINARY_NEW_AddAffect(self, type, pointIdx, value, duration):
		...
		## ¿ë½ÅÀÇ °¡È£, ¼±ÀÎÀÇ ±³ÈÆÀº Duration À» 0 À¸·Î ¼³Ý¤ÇÑ´Ù.
		...
		if trashValue == 1:
			...
			if affect != chr.NEW_AFFECT_AUTO_SP_RECOVERY and affect != chr.NEW_AFFECT_AUTO_HP_RECOVERY and not self.AFFECT_PET_DATA_DICT.has_key(affect):
				if app.ENABLE_NEW_AUTOPOTION:
					if affect < chr.AFFECT_AUTO_ATTACK_SPEED_RECOVERY + 20 or affect > chr.AFFECT_AUTO_WHITE_POTION_RECOVERY + 20:
	...
	def SetMountActive(self):
		if int(constInfo.Mount_Affect["status"]) == 0:
			if self.mountImage:
				self.mountImage.Hide()
			self.mountImage=None
		else:
			image = MountImage()
			image.SetParent(self)
			image.SetState(constInfo.Mount_Affect["vnum"])
			image.Show()

			self.mountImage=image
		self.__ArrangeImageList()
	...
	def __ArrangeImageList(self):
		...
		height = len(self.affectImageDict) * self.IMAGE_STEP
		...
		height = self.IMAGE_HEIGHT*(((height/self.IMAGE_HEIGHT)/self.COUNT_LINE)+1)

		if (width/self.IMAGE_STEP) < self.COUNT_LINE:
			width = self.IMAGE_STEP * (width/self.IMAGE_STEP)
		else:
			width = self.IMAGE_STEP * self.COUNT_LINE
		...
		if self.lovePointImage:
			if self.lovePointImage.IsShow():
				...
				xPos += self.IMAGE_STEP
				if self.FuncLineCount(xPos):
					yPos += self.IMAGE_HEIGHT
					xPos = 0
		...
		if self.mountImage:
			self.mountImage.SetPosition(xPos, yPos)
			xPos += self.IMAGE_STEP
			if self.FuncLineCount(xPos):
				yPos += self.IMAGE_HEIGHT
				xPos = 0
	...
	def FuncLineCount(self,number):
		test = number / self.IMAGE_STEP
		cal = test % self.COUNT_LINE
		if cal == 0:
			return True
