		...
		## Pet Mini Information Window Back Ground
		{
			...
			(
				## Icon Slot
				{
					...
					(
						...
						## Main Slot
						{
							...
							"width"	: 35,
							"height" : MINI_WINDOW_HEIGHT,
							"default_image" : PET_MINI_INFO_SLOT_FILE,
							"over_image" : PET_MINI_INFO_SLOT_FILE,
							"down_image" : PET_MINI_INFO_SLOT_FILE,
						},
				...
				## Skill Slot 1
				{
					...
					"slot" : ({"index":0, "x":36, "y":25, "width":16, "height":16,},{"index":1, "x":58, "y":25, "width":16, "height":16,},{"index":2, "x":80, "y":25, "width":16, "height":16,},),
				},
				## EXP Gauge
				{
