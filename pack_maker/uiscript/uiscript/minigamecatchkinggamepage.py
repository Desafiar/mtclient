	...
	(
		{
			...
			"title" : uiScriptLocale.MINI_GAME_WINDOW_TITLE,
			...
			(
					...
					(
						...
						{ 
							...
							(
								...
								{"name":"my_number_text", "type":"text", "x":0, "y":0, "text": uiScriptLocale.MINI_GAME_MY_CARD, "all_align" : "center"},
							),	
						},
						## my number - card bg
						{
						...
						{ 
							...
							(
								...
								{"name":"selection_number_text", "type":"text", "x":0, "y":0, "text": uiScriptLocale.MINI_GAME_MY_CARDS, "all_align" : "center"},
							),	
						},
							...
							(
								...
								{ 
									...
									(
										...
										{"name":"score_title_text", "type":"text", "style" : ("not_pick",), "x":0, "y":0, "text": uiScriptLocale.MINI_GAME_POINTS, "all_align" : "center"},
									),	
								},
								## score text window
								{ 
				...
				{ 
					...
					(
						...
						{"name":"high_score_title_text", "type":"text", "style" : ("not_pick",), "x":0, "y":0, "text": uiScriptLocale.MINI_GAME_BIG_POINTS, "all_align" : "center"},
					),	
				},
				...
				{ 
					...
					(
						...
						{"name":"confirm_check_text", "type":"text", "style" : ("not_pick",), "x":0, "y":0, "text": uiScriptLocale.MINI_GAME_POPUP, "all_align" : "center"},
					),	
				},
				{
