...
class TeleportWindow(ui.ScriptWindow):
	...
	def LoadWindow(self):
		...
		try:
			...
			self.GetChild('backButton').ShowToolTip = lambda arg = localeInfo.TELEPORT_WINDOW_BACK_BUTTON_TOOLTIP : self.OverInToolTipButton(arg)
			self.GetChild('backButton').HideToolTip = lambda : self.OverOutToolTipButton()
