	...
	(
		{
			...
			(
				...
				{ 
					...
					"children" :
					(
						{"name":"TitleName", "type":"text", "x":0, "y":0, "text":"PetSystem", "all_align" : "center"},
					),	
				},
				...
				{ 
					...
					"children" :
					(
						{"name":"LevelTitle", "type":"text", "x":0, "y":0, "text": uiScriptLocale.PET_SYSTEM_4, "color":GOLD_COLOR, "all_align" : "center"},
					),	
				},
				## Level Value
				{ 
				...
				{ 
					...
					"children" :
					(
						{"name":"ExpTitle", "type":"text", "x":0, "y":0, "text": uiScriptLocale.PET_SYSTEM_5, "color":GOLD_COLOR, "all_align" : "center"},
					),	
				},
				## EXP Gauge
				{
				...
				{ 
					...
					"children" :
					(
						{"name":"AgeTitle", "type":"text", "x":0, "y":0, "text": uiScriptLocale.PET_SYSTEM_6, "color":GOLD_COLOR, "all_align" : "center"},
					),	
				},
				## AGE Value
				{ 
				...
				{ 
					...
					"children" :
					(
						{"name":"LifeTitle", "type":"text", "x":0, "y":0, "text": uiScriptLocale.PET_SYSTEM_7, "color":GOLD_COLOR, "all_align" : "center"},
					),	
				},
				...
				## UpBringing Pet Feed Button(Life Time Increase)
				{
					...
					"text" : uiScriptLocale.PET_SYSTEM_3,
				...
				## UpBringing Pet Feed Button(evolution)
				{
					...
					"text" : uiScriptLocale.PET_SYSTEM_8,
					"text_color" : GOLD_COLOR,
				},
				...
				## UpBringing Pet Feed Button(EXP)
				{
					...
					"text" : uiScriptLocale.PET_SYSTEM_9,
					"text_color" : GOLD_COLOR,
				},
				...
				{ 
					...
					"children" :
					(
						{"name":"AbilitiesName", "type":"text", "x":0, "y":0, "text": uiScriptLocale.PET_SYSTEM_10, "r":1.0, "g":0.0, "b":0.0, "a":1.0, "all_align" : "center"},
					),	
				},
				...
				{ 
					...
					"children" :
					(
						{"name":"HpTitle", "type":"text", "x":0, "y":0, "text": uiScriptLocale.PET_SYSTEM_11, "color":GOLD_COLOR, "all_align" : "center"},
					),	
				},
				## HP Value
				{ 
				...
				{ 
					...
					"children" :
					(
						{"name":"DefTitle", "type":"text", "x":0, "y":0, "text": uiScriptLocale.PET_SYSTEM_12, "color":GOLD_COLOR, "all_align" : "center"},
					),	
				},
				## Defence Value
				{ 
				...
				{ 
					...
					"children" :
					(
						{"name":"SpTitle", "type":"text", "x":0, "y":0, "text": uiScriptLocale.PET_SYSTEM_13, "color":GOLD_COLOR, "all_align" : "center"},
					),
				},
				## SP Value
				{ 
				...
				{ 
					...
					"children" :
					(
						{"name":"PetSkillTitle", "type":"text", "x":0, "y":0, "text": uiScriptLocale.PET_SYSTEM_14, "r":1.0, "g":0.0, "b":0.0, "a":1.0, "all_align" : "center"},
					),
				},
