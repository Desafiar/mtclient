	...
	'children': (
		...
		{'name': 'info_board', 'type': 'thinboard_special_1', 'x': 150, 'y': 135, 'width': WINDOW_WIDTH - 307, 'height': 132, 'vertical_align': 'bottom',
			'children': [
				...
				{'name': 'backButton', 'type': 'button', 'x': 7, 'y': 77 + 24, 'default_image': PATH + 'back_btn_01.png', 'over_image': PATH + 'back_btn_02.png', 'down_image': PATH + 'back_btn_03.png'},
				{'name': 'warpButton', 'type': 'button', 'x': 7+37, 'y': 77 + 24, 'text': uiScriptLocale.TELEPORT_WINDOW_BUTTON_TELEPORT, 'default_image': PATH + 'warp_btn_01.png', 'over_image': PATH + 'warp_btn_02.png', 'down_image': PATH + 'warp_btn_03.png'},
			],
		},
	),
}