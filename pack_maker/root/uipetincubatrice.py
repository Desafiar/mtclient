...
class PetSystemIncubator(ui.ScriptWindow):
	...
	def LoadPetIncubatorImg(self, new_pet):
		petarryname = ["Uovo di Scimmia", "Uovo di Ragno", "Uovo di Razador", "Uovo di Nemere"]
	...
	def RequestHatching(self):
		...
		if player.GetElk() < 100000:
			chat.AppendChat(chat.CHAT_TYPE_INFO, "Devi possedere: "+str(localeInfo.NumberToMoneyString(100000)) +".")
			return
