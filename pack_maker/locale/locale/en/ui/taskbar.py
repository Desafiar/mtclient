...
window = {
	...
	(
		...
		## Button
		{
			...
			"x" : SCREEN_WIDTH - (144+34+34),
			"y" : 3 + Y_ADD_POSITION,

			"tooltip_text" : uiScriptLocale.CALENDAR_TITLE,

			"default_image" : ROOT + "TaskBar/calendario_1.tga",
			"over_image" : ROOT + "TaskBar/calendario_2.tga",
			"down_image" : ROOT + "TaskBar/calendario_3.tga",
		},
