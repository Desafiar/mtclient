	...
	class TrackItem(ui.ScriptWindow):
		...
		def __LoadWindow(self):
			...
			if app.ENABLE_CONQUEROR_LEVEL:
				if self.__dataDict["index"] == 10 or self.__dataDict["index"] == 11:
					GetObject("level_field").SetOutline()
					GetObject("level_field").SetPackedFontColor(0xFFBFD9FF)
					GetObject("level_field").SetOutLineColor(0xFF0066FF)
	...
	def __LoadWindow(self):
		...
		self.__dataDict = {
			...
			0 : [\
				...
				{
					"trackType": 0,
					"name": localeInfo.NIGHTMARE,
					"level_range": [110, 120],
					"group": False,
					"cooldown": 60 * 60 * 2,
					"server_cooldown": 0,
					"img": IMG_DIR_AVATAR+"nightmare.tga",
					"tickets": [[30753, 1]],
					"bossVnum": 4043,
					"status" : False,
					"deactiveType" : 0,
				...
				{
					"trackType": 0,
					"name": localeInfo.MAGICTROLL,
					"level_range": [110, 120],
					"group": False,
					"cooldown": 60 * 60 * 2,
					"server_cooldown": 0,
					"img": IMG_DIR_AVATAR+"bestia.tga",
					"tickets": [[30781, 1]],
					"bossVnum": 4095,
					"status" : False,
					"deactiveType" : 0,
				...
				{
					"trackType": 0,
					"name": localeInfo.SERPENT_QUEEN,
					"level_range": [1, 15],
					"group": True,
					"cooldown": 60 * 60 * 3,
					"server_cooldown": 0,
					"img": IMG_DIR_AVATAR+"queen.tga",
					"tickets": [[70430, 1]],
					"bossVnum": 6756,
					"status" : False,
					"deactiveType" : 0,
				...
				{
					"trackType": 0,
					"name": localeInfo.ALASTOR,
					"level_range": [1, 25],
					"group": True,
					"cooldown": 60 * 60 * 3,
					"server_cooldown": 0,
					"img": IMG_DIR_AVATAR+"alastor.tga",
					"tickets": [[70431, 1]],
					"bossVnum": 6790,
					"status" : False,
					"deactiveType" : 0,
