...
itemShopCategoryData = {
	0:{
		...
		"subCategory":[localeInfo.CATEGORY_0_SUB_0_NAME, localeInfo.CATEGORY_0_SUB_1_NAME],
		},
	1:{
	...
	# 3:{
		...
		# "subCategory":[localeInfo.CATEGORY_3_SUB_0_NAME,localeInfo.CATEGORY_3_SUB_1_NAME,localeInfo.CATEGORY_3_SUB_2_NAME,localeInfo.CATEGORY_3_SUB_3_NAME,localeInfo.CATEGORY_3_SUB_4_NAME,localeInfo.CATEGORY_3_SUB_5_NAME],
		# },
	# 4:{
	...
	5:{
		...
		"subCategory":[localeInfo.CATEGORY_5_SUB_0_NAME,localeInfo.CATEGORY_5_SUB_1_NAME,localeInfo.CATEGORY_5_SUB_2_NAME],
		},
	6:{
	...
	7:{
		...
		"subCategory":[localeInfo.CATEGORY_7_SUB_0_NAME, localeInfo.CATEGORY_7_SUB_1_NAME, localeInfo.CATEGORY_7_SUB_2_NAME],
		},
	8:{
	...
	10:{
		...
		"subCategory":[localeInfo.CATEGORY_10_SUB_0_NAME,localeInfo.CATEGORY_10_SUB_1_NAME,localeInfo.CATEGORY_10_SUB_2_NAME,localeInfo.CATEGORY_10_SUB_3_NAME,localeInfo.CATEGORY_10_SUB_4_NAME,localeInfo.CATEGORY_10_SUB_5_NAME,],
		},
	11:{
		"name":localeInfo.CATEGORY_11_NAME,
		"subCategory":[localeInfo.CATEGORY_11_SUB_0_NAME, localeInfo.CATEGORY_11_SUB_1_NAME, localeInfo.CATEGORY_11_SUB_2_NAME],
		},
	12:{
		"name":localeInfo.CATEGORY_12_NAME,
		"subCategory":[localeInfo.CATEGORY_12_SUB_0_NAME, localeInfo.CATEGORY_12_SUB_1_NAME],
		},
}
...
class ItemShopWindow(ui.Window):
	...
	def LoadWindow(self):
		...
		wheelBtn.SetPosition(180 + ((buyCoinBtn.GetWidth() + 7) * countBtn), 12)
		# wheelBtn.Show()
		...
		purchasesBtn.SetPosition(180 + ((buyCoinBtn.GetWidth() + 7) * countBtn), 12)
		# purchasesBtn.Show()
		...
		hotItemsBtn.SetPosition(180 + ((buyCoinBtn.GetWidth() + 7) * countBtn), 12)
		hotItemsBtn.Show()
		...
		offersBtn.SetPosition(180 + ((buyCoinBtn.GetWidth() + 7) * countBtn), 12)
		offersBtn.Show()
...
class BuyWindow(ItemShopBoard):
	...
	def __init__(self):
		...
		yesBtn.SetDownVisual(IMG_DIR+"buy_2.tga")
		yesBtn.SetText(localeInfo.ITEMSHOP_BUY) 
		yesBtn.Show()
...
class ItemShopItem(ui.ExpandedImageBox):
	...
	def SetItem(self, itemVnum):
		...
		if app.ENABLE_RENDER_TARGET:
			itemImage.SetEvent(ui.__mem_func__(self.ClickItem), "mouse_click", itemVnum)
		itemImage.Show()
		self.childrenImages["itemImage"] = itemImage

	if app.ENABLE_RENDER_TARGET:
		def ClickItem(self, emptyArg, itemVnum):
			if app.IsCanOpenRender():
				interface = constInfo.GetInterfaceInstance()
				if interface:
					interface.OpenRenderTargetWindow(0, itemVnum)
